...
\begin{frame}[fragile]
  \frametitle{Écriture d'un fichier en mode append\chrono}
...
\textcolor[rgb]{0,0.58,0}{# Ouverture du fichier texte en é criture}
...
\textcolor[rgb]{0,0,1}{with} open('data.txt','\textcolor[rgb]{1,0.41,0.13}{rb}') as f:}

...
\small{
 \begin{exemple}[Modification d'une variable globale en local]
    ...
    \textcolor[rgb]{0,0,1}{global} compteur  \textcolor[rgb]{0,0.58,0}{# définition var. globale}
    compteur += 1
    print('Appelé', compteur, 'fois')

compteur = 0 \textcolor[rgb]{0,0.58,0}{# initialisation du compteur}
incremCompt() \textcolor[rgb]{0,0.58,0}{# => affiche: Appelé 1 fois}
...
\begin{frame}
  \frametitle{Condition d'arrêt\chrono}
...
\begin{frame}
  \frametitle{Pile et récursivité\chrono}
...
\begin{frame}[fragile]
  \frametitle{Post et pré-traitement\chrono}
  ...
  \begin{semiverbatim}\scriptsize{
	...
	def puissance(x,n):
	    if n == 0:
	        ...
	        \only<3,5>{print("prétraitement pour n :", n)} 
...
\begin{frame}
  \frametitle{Suite de Fibonacci\chrono}
  $\left\{
    \begin{array}{l}
      \color<2>{red}F_0 = 0\\
      \color<2>{red}F_1 = 1\\
...
\begin{frame}
  \frametitle{Explosion de la pile d'appel\chrono}
...
\begin{frame}
  \frametitle{Conception d'algorithme récursif\chrono}
...
\begin{frame}
  \frametitle{Recherche par dichotomie\chrono}
...
\begin{frame}[fragile]
  \frametitle{Tours de Hanoï\chrono}
  Principe :
  \begin{itemize}
...
\begin{frame}
  \frametitle{Tours de Hanoï : résolution\chrono}
  \begin{itemize}
...
\begin{frame}
  \frametitle{Tours de Hanoï : algorithme\chrono}
...
\begin{frame}
  \frametitle{Étude de l'algorithme tours de Hanoï\chrono}
...
\begin{frame}
  \frametitle{Récursivité terminale\chrono}
...
\begin{frame}
  \frametitle{Écriture de fonction récursive terminale\chrono}
  \begin{itemize}
...
\begin{frame}[fragile]
  \frametitle{Fonctionnement\chrono}
  Appel :
  \begin{semiverbatim}
    fact(4, 1)
  \end{semiverbatim}

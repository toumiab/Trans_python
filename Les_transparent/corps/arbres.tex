...
\begin{frame}[fragile]
  ...
  \begin{block}{Code}
    \begin{lstlisting}[frame=single,escapechar=\#]
      public class Node {
        #\visible<2->{#private String value;#}#
        #\visible<3->{#private Node left;  #}#
        #\visible<3->{#private Node right; #}#
        #\visible<4->{#public Node(String val) \{ #}#
        #\visible<4->{#  value = val;  #}#
        #\visible<5->{#  left = null; #}#
        #\visible<5->{#  right = null; #}#
        }
        ...
      }
    \end{lstlisting}
...
%
%    \hspace{2cm}left = null;
%
%    \hspace{2cm}right = null;
%
%  \hspace{1cm}\}
%
%  \hspace{1cm}...
...
\begin{frame}
  ...
  \item En \emph{Java} : chaque noeud possède un tableau de $n$ fils
...
%  \KwData{ n : noeud \tcp{ noeud courant}}
  ...
  retourner $n$ \tcp{ n a la valeur recherchée ou n vaut \emph{null}}
\end{algorithm2e}
  % \begin{algorithmic}[1]
  ...
  %       \EndIf
  %     \EndWhile
  %     \State retourner $n$ \Comment n a la valeur recherchée ou n vaut \emph{null}
  %   \EndProcedure
  % \end{algorithmic}
\end{frame}
...
\begin{frame}
  \frametitle{Demo}
  \href{https://moodle.ensta-bretagne.fr/mod/resource/view.php?id=14500}{\includegraphics[height=5cm]{arbre_ins}}
\end{frame}
...
\begin{procedure}[H]
  ...
  \tcp{ maintenant le fils de \emph{pere} est null}
\end{procedure}
  % \begin{algorithmic}[1]
  ...
  %         \State $n \gets n.filsDroit$
  %       \EndIf
  %     \EndWhile \Comment maintenant le fils de \emph{pere} est null
  %   \EndProcedure
  % \end{algorithmic}
  }
  \only<3>{
\begin{procedure}[H]
  \caption{insert(noeud val,noeud pere)}
  \tcp{ \ldots{} maintenant le fils de \emph{pere} est null}
  \eIf{$val < pere$} {
...
\end{procedure}
  % \begin{algorithmic}[1]
  %   \Procedure{insert}{noeud val,noeud pere}
  %     \State \ldots{}  \Comment maintenant le fils de \emph{pere} est null
  %     \If{$val < pere$}
...
\begin{frame}
  ...
  \item remplacer le noeud par le sous-arbre
...
\begin{frame}
  ...
  \only<2>{
    \begin{center}
      \includegraphics[height=5cm]{arbre_synt}
    \end{center}
  }
\end{frame}
...
\begin{frame}
  ...
  \only<2>{
    \begin{center}
      \includegraphics[height=5cm]{arborescence_fic}
    \end{center}
  }
\end{frame}
...
\begin{frame}
  \frametitle{Exemple}
    ...
    \begin{center}
      \includegraphics[height=5cm]{arbre_desequilibre}
    \end{center}
\end{frame}
...
\begin{frame}
  ...
  \only<1>{
    \begin{center}
      \includegraphics[height=5cm]{equilibrage1}
    \end{center}
  }
  \only<2>{
    \begin{center}
      \includegraphics[height=5cm]{equilibrage2}
    \end{center}
  }
  \only<3>{
    \begin{center}
      \includegraphics[height=5cm]{equilibrage3}
    \end{center}
  }
  \only<4>{
    \begin{center}
      \includegraphics[height=5cm]{equilibrage4}
    \end{center}
  }

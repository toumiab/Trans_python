    ...
    \verb!\colorbox{pink}{>>> s[-1] \# \footnotesize{renvoie le dernier élément de la séquence s}}!
     ...
     \verb!\colorbox{pink}{>>> s[0:2] \# \footnotesize{renvoie une séquence contenant s[0] et s[1]}}!
			...
			\begin{itemize}
				...
				\item \verb![i:]! : désigne tout ce qui suit i (i est inclu)
...
\begin{itemize}%[<+->]
	  ...
	  \item <8->Pour la modifier, il faut créer une nouvelle.
		\item <12-> Les opérateurs '*' et '+' réalisent la multiplication et le concaténation
		\end{itemize}
...
\begin{frame}
  \frametitle{Les listes}
	...
	\begin{itemize}[<+->]
		\item 
		\item Elles sont modifiables
		\item Elles peuvent contenir des éléments hétérogènes (de types différents)
		\end{itemize}
    \pause

  ...
  \frametitle{Définition}
	\begin{remarques}[Quelques remarques importantes ]
		...
		\begin{itemize}
			...
			\item Le constructeur d'une classe est une méthode spéciale qui s'appelle \texttt{blue}{$\_\_init\_\_()$}.
			\item Les attributs (variables d'instance) sont créés  et initialisés dans le constructeur 
...
\begin{frame}
  \frametitle{Notion de classe et d'objet en Python}
  \begin{itemize}
...
\begin{frame}
  \frametitle{Visibilité des attributs }
  \begin{remarque}
 ...
 Par convention :
		...
		\begin{itemize}
		  \item Une variable dont le nom commence par $(\_) \Longrightarrow$ est considérée comme \emph{protect}
...
\begin{frame}
  ...
  \begin{exemple}
	  \begin{semiverbatim}
        ...
        \hspace{1.5cm}self.\textcolor[rgb]{1,0,0}{\_}prenom = "xxx" \textcolor[rgb]{0,0.58,0}{\# Variable protégée}

...
\begin{frame}
  ...
  \begin{exemple}[Déclaration de tableaux]
    \begin{semiverbatim}
      {\color[rgb]{0,0.7,0}{{\scriptsize // \textit{idEtudiants} est un tableau à une dimension de \emph{int}}}}
      
      int idEtudiants[]; 
		
			{\color[rgb]{0,0.7,0}{{\scriptsize//\textit{Notes} est untableau à une dimension de \emph{char}}}}
			
      char[] notes;

      {\color[rgb]{0,0.7,0}{{\scriptsize //\textit{coordonnees} est un tableau à deux dimensions \emph{double}}}}
  ...
  \begin{exemple}[Création et initialisation de tableau]
    \begin{semiverbatim}
      ...
      double coordonnees[][] = \{\{0.0,0.1\},\{0.2,0.3\}\}; 
       ...
       {\color[rgb]{0.7,0,0}{ // coordonnees[][] = \{\{0.0,0.1\},\{0.2,0.3\}\};}}
       
       {\color[rgb]{0.7,0,0}{ // l'intialisation n'est utilisable qu'à la déclaration}} 
    \end{semiverbatim}
  \end{exemple}  
\end{frame}
...
\begin{frame}
  ...
  \begin{exemple}
    ...
    \only<11> {\includegraphics[width=4cm, height=8.5cm]{tris_bul.jpg}}
  \end{exemple}
\end{frame}
